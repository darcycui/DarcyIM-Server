...
object TransportCipherAESGCM : ITransportCipher {

    private val TAG = TransportCipherAESGCM::class.simpleName
    private const val ALGORITHM =  "AES/GCM/NoPadding"
    private const val NONCE_SIZE_BYTES = 12 // GCM 标准 Nonce 大小为 96位 (12字节)
    private const val GCM_TAG_LENGTH_BITS = 128 // GCM Tag 长度设为 128位
    ...
    override fun encrypt(
        ...
        return kotlin.runCatching {
            ...
            val ivSpec = GCMParameterSpec(GCM_TAG_LENGTH_BITS, nonce)
